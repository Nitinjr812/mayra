    ...
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-[#0d0b09]">
      ...
      <div className="absolute top-8 right-8 flex gap-4 z-20">
        <a
          ...
          className="w-9 h-9 border border-[#b89a6a]/50 flex items-center justify-center text-[#d4b896] hover:bg-[#b89a6a] hover:text-[#0d0b09] transition-all duration-300"
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="hero-content-delay mb-8">
          <img
            ...
            alt="Mayra by Gungun"
            className="max-w-[380px] md:max-w-[520px] mx-auto"
            onError={(e) => {
          ...
          {/* Fallback text */}
          <h1
            className="font-cormorant text-[clamp(3.5rem,8vw,6rem)] font-light text-[#faf6f0] leading-[1.05]"
          >
    ...
    <section className="bg-[#faf6f0] border-y border-[#e8ddd2]">
      <div className="grid grid-cols-2 md:grid-cols-4 max-w-6xl mx-auto">
        {badges.map((b, i) => (
          <div
            key={i}
            className={`trust-badge flex flex-col items-center text-center py-8 px-4 ${i < 3 ? "border-r border-[#e8ddd2]" : ""
              }`}
          >
...
const CATEGORY_FALLBACKS: Record<string, string> = {
  ranihaar: "https://mayrabygungun.com/public/uploads/all/1KxbXlaZDucvCvMc61oyqT4HfLJFU14grFKGY2QX.png",
  "hand-bags": "https://mayrabygungun.com/public/uploads/all/v2GSQ59vHj9HbyAmZTNV3Mwom3p757xDuHBvpNcz.png",
  earrings: "https://mayrabygungun.com/public/uploads/all/2ZcfwgkActvMs8Sf2JTN3XzgLjVFkKmqRw5PCLkW.png",
  bangles: "https://mayrabygungun.com/public/uploads/all/tJ6t2JyzdSWK4i9DfSEXoEzYAjCd51jhjxNxQaf6.jpg",
  necklace: "https://mayrabygungun.com/public/uploads/all/FBEKyzaKjImOLw1dvRcvQ2X5RgwEu9hDJ2QWHSpN.jpg",
};

function CategoryGrid({ collections }: { collections: CollectionNode[] }) {
  // Use real data or fill with known categories
  ...
  return (
    <section className="bg-[#faf6f0] py-20 px-4 lg:px-10">
      ...
      {/* 5-column grid: 2 big + 3 small */}
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {displayCollections.map((col, index) => {
            const fallbackKey = Object.keys(CATEGORY_FALLBACKS).find((k) =>
              col.handle.toLowerCase().includes(k)
            );
            const imgSrc =
              col.image?.url ||
              (fallbackKey ? CATEGORY_FALLBACKS[fallbackKey] : null);
            ...
            return (
              ...
              >
                {imgSrc ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-b from-[#e8ddd2] to-[#d4c4b0]" />
                )}
                {/* Hover overlay */}
                <div
                  className="card-overlay absolute inset-0 bg-gradient-to-t from-[#0d0b09]/80 via-[#0d0b09]/20 to-transparent opacity-60 transition-opacity duration-500"
                />
                <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                  <h3 className="font-cormorant text-xl font-light leading-tight">
                    {col.title}
                  </h3>
                  <span className="text-[9px] tracking-[0.25em] uppercase text-[#d4b896] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    View Collection →
                  </span>
                </div>
              </Link>
...
// ─────────────────────────────────────────
// FEATURES (Fine Jewelry Features)
// ─────────────────────────────────────────
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="relative min-h-[400px] lg:min-h-[560px]">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-transparent to-[#faf6f0]/10" />
      </div>

      {/* Text */}
      <div className="bg-[#faf6f0] px-10 lg:px-16 py-20 flex flex-col justify-center">
    ...
    <section className="bg-white py-20 px-4 lg:px-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5 max-w-6xl mx-auto">
        {products.slice(0, 8).map((product) => (
          ...
          >
            <div
              className="relative overflow-hidden bg-[#f0ebe4] mb-4 rounded-sm"
            ...
            >
              {product.featuredImage ? (
                ...
                <div className="w-full h-full bg-[#e8ddd2]" />
              )}
              {/* Hover quick view */}
              <div className="quick-view absolute bottom-0 left-0 right-0 bg-[#0d0b09] text-[#d4b896] text-[9px] tracking-[0.25em] uppercase py-3 text-center translate-y-full transition-transform duration-300">
                Quick View
              </div>
              {/* Wishlist icon */}
              <button
                className="absolute top-3 right-3 w-8 h-8 bg-white/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 hover:bg-[#b89a6a] hover:text-white"
...
function MidVideoSection() {
  return (
    <section className="relative h-[500px] md:h-[600px] flex items-center justify-center overflow-hidden bg-[#0d0b09]">
      <video
...
const FALLBACK_ARTICLES = [
  {
    id: "1",
    title:
      "The Ultimate Guide to Finding the Perfect Necklace: Unveiling the Best Styles, Materials.",
    handle: "the-ultimate-guide-to-finding-the-perfect-necklace-unveiling-the-best-styles-materials",
    publishedAt: "2024-03-04",
    image: {
      url: "https://mayrabygungun.com/public/uploads/all/Rc4XaRf4mYOgRPiqNT4N5aZbzvNnNLc420VK3d9Q.png",
    },
    blog: { handle: "news" },
  },
  {
    ...
    publishedAt: "2024-03-04",
    image: {
      url: "https://mayrabygungun.com/public/uploads/all/ZlNnNcJcl9rSEZVSlaI3ebThRXqk9TsoNgZ4Qzvv.png",
    },
    blog: { handle: "news" },
  },
  {
    id: "3",
    title:
      "The Timeless Art of Meenakari: Celebrating Heritage with Mayra by Gungun",
    handle: "the-timeless-art-of-meenakari-celebrating-heritage-with-mayra-by-gungun",
    publishedAt: "2023-10-17",
    image: {
      url: "https://mayrabygungun.com/public/uploads/all/qOG2CMlazHlw5rbOqDdwGQCXT1AOsp5XVSgjrcG0.png",
    },
    blog: { handle: "news" },
  },
];
...
function BlogSection({ articles }: { articles: ArticleNode[] }) {
  const displayArticles =
    articles.length > 0 ? articles.slice(0, 3) : FALLBACK_ARTICLES;
...
function InstagramSection() {
  // Placeholder tiles for Instagram feed
  const tiles = [
  ...
  return (
    <section className="bg-white py-16 px-4">
      <div className="text-center mb-10">
        ...
        <p className="text-xs text-[#8a7a6e] mt-2 tracking-wide">
          Our Instagram Feeds
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-2 max-w-6xl mx-auto">
        {tiles.map((src, i) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-[#b89a6a]/0 group-hover:bg-[#b89a6a]/30 transition-colors duration-300 flex items-center justify-center">
              <svg
...
function NewsletterSection() {
  ...
  return (
    <section className="bg-[#b89a6a] py-16 px-6 text-center relative overflow-hidden">
      ...
      >
        <span
          className="font-cormorant text-[20vw] font-light text-[#a08050]/20 leading-none whitespace-nowrap"
        >
          Mayra
        </span>
      </div>
      ...
      <div className="relative z-10">
        <p className="text-[#1a1410]/60 text-[10px] tracking-[0.4em] uppercase mb-4">
          Inner Circle
        </p>
        <h2 className="font-cormorant text-4xl lg:text-5xl font-light text-[#1a1410] mb-2">
        ...
        {submitted ? (
          <p className="text-[#1a1410] font-medium tracking-wide">
          ...
          <div className="flex max-w-md mx-auto border border-[#1a1410]/30 bg-white/20">
            <input
              ...
              className="flex-1 px-5 py-3 bg-transparent text-[#1a1410] text-sm placeholder:text-[#1a1410]/50 outline-none"
            />
            <button
              type="button"
              onClick={() => {
              ...
              className="px-6 py-3 bg-[#1a1410] text-[#d4b896] text-[10px] tracking-[0.25em] uppercase hover:bg-[#3d322a] transition-colors"
            >
              Submit
            </button>
          </div>
    ...
    <footer className="bg-[#1a1410] text-[#faf6f0]/70">
      ...
      <div className="max-w-6xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          <Link to="/" className="block mb-5">
            ...
            />
            <h3 className="font-cormorant text-2xl text-[#faf6f0] font-light mt-2">
              Mayra by Gungun
            </h3>
          </Link>
        ...
        {/* Pages */}
        <div>
          <h4 className="text-[10px] tracking-[0.3em] uppercase text-[#faf6f0] mb-6">
            Pages
          </h4>
          <ul className="space-y-3">
            {[
              ...
              <li key={item.label}>
                <Link
                  to={item.to}
                  className="text-sm hover:text-[#b89a6a] transition-colors"
                >
                  {item.label}
                </Link>
              </li>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li className="flex gap-3 items-start">
              <svg
                className="text-[#b89a6a] flex-shrink-0 mt-0.5"
                width="14"
                height="14"
                fill="none"
                stroke="currentColor"
              ...
              <a href="tel:+919660090441" className="text-sm hover:text-[#b89a6a]">
                +91 96600 90441
              </a>
            </li>
            <li className="flex gap-3 items-start">
              ...
              <a
                href="mailto:mayrabygungun2@gmail.com"
                className="text-sm hover:text-[#b89a6a] break-all"
              >
            ...
            <li className="flex gap-3 items-start">
              ...
              <p className="text-sm leading-relaxed">
                Bordi Ka Rasta, 607, Kishanpole Bazar,
                <br />
      ...
      <div className="border-t border-[#faf6f0]/10">
        <div className="max-w-6xl mx-auto px-8 py-5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#faf6f0]/40">
            ©2024–2025 MayraByGungun. All Rights Reserved.
          </p>
